...
class Add_Contact(unittest.TestCase):
    ...
    def test_Add_Contact(self):
        ...
        wd.find_element_by_name("lastname").send_keys("Testov")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("Testik")
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").clear()
        wd.find_element_by_name("title").send_keys("For python training")
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys("Big")
        ...
        wd.find_element_by_name("phone2").send_keys("h.5 f. 35")
